...
plot_round_paths <- c("./discr_figs/france_by_round_rlg.gif",
                      "./discr_figs/england_by_round_rlg.gif")
# set outcome animation paths
plot_outcome_paths <- c("./discr_figs/france_by_outcome_rlg.gif",
                        "./discr_figs/england_by_outcome_rlg.gif")
...
for(i in 1:length(df_list)) {
  ...
  plot_list[[i]] <- 
    ...
    labs(title = "Proportion of Muslims Discriminated Against", 
